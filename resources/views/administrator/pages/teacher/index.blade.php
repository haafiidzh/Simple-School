...
@section('content')
    ...
    <div class="mb-7 py-3 flex justify-between">
        <h1 class="font-bold text-3xl">Guru</h1>
        {{-- @can('create-news') --}}
            <a href="{{ route('administrator.teacher.create') }}"
                ...
                <i class="text-xs fa-solid fa-plus"></i> &nbsp; Tambah Guru
            </a>
        {{-- @endcan --}}
    </div>
    <livewire:administrator.teacher.table />
@endsection

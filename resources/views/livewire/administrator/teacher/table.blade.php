            ...
            <div class="p-2">
                <div class="p-1 flex justify-between items-center">
                    <div class="flex items-center gap-2">
                        ...
                        <input placeholder="Cari Guru..." id="search" type="text" class="text-sm p-1 rounded-md"
                        ...
                        <tr class="hover:bg-gray-200 {{ $loop->last ? '' : 'border-b border-gray-200' }}">
                            ...
                            <td class="px-4 py-2">
                                <div class="flex gap-2 justify-center">
                                    {{-- @can('detail-users') --}}
                                            <a href="{{ route('administrator.teacher.detail', ['id' => $data->id]) }}"
                                        ...
                                        {{-- @endcan --}}
                                        {{-- @can('edit-users') --}}
                                            <a href="{{ route('administrator.teacher.edit', ['id' => $data->id]) }}"

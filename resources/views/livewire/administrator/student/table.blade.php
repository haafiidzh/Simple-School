                        ...
                        <tr class="hover:bg-gray-200 {{ $loop->last ? '' : 'border-b border-gray-200' }}">
                            ...
                            <td class="px-4 py-2">
                                <div class="flex gap-2 justify-center">
                                    {{-- @can('detail-users') --}}
                                            <a href="{{ route('administrator.student.detail', ['id' => $data->classroom_id, 'studentId' => $data->id]) }}"
                                        ...
                                        {{-- @endcan --}}
                                        {{-- @can('edit-users') --}}
                                            <a href="{{ route('administrator.student.edit', ['id' => $data->classroom_id, 'studentId' => $data->id]) }}"
